...
const COPY = {
  ...
  [AUTH_STATES.LEGAL_CONSENT_REQUIRED]: {
    title: 'נדרש אישור לתנאים המעודכנים',
    body: 'כדי להמשיך, יש לעיין בתנאי השימוש ובמדיניות הפרטיות המעודכנים ולאשר אותם פעם אחת.',
    action: 'לעיון ואישור',
  },
