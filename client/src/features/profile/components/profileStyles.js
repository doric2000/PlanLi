...
export function createProfileStyles(insets = {}, width = 390, gridColumns = 3) {
  ...
  return StyleSheet.create({
    ...
    preferencesSection: {
      marginTop: 14,
      marginHorizontal: 8,
      paddingHorizontal: tablet ? 20 : 16,
      paddingVertical: tablet ? 20 : 17,
      borderRadius: 22,
      backgroundColor: colors.white,
      borderWidth: 1,
      borderColor: '#E2E7EE',
