...
export const dayEditorModalStyles = StyleSheet.create({
    ...
    removeDayNote: { alignSelf: 'flex-end', minHeight: 44, justifyContent: 'center' },
    removeDayNoteText: {
        color: colors.textMuted,
        fontSize: 13,
        textAlign: 'right',
...
export const routeStopMarkerStyles = StyleSheet.create({
	...
	dayBadgeTextCompact: { fontSize: 8 },
});
...
export const routeItineraryStyles = StyleSheet.create({
	...
	dayHeader: {
		minHeight: 84, padding: 14, flexDirection: 'row-reverse', alignItems: 'center', gap: 12,
	...
	dayFallbackText: { color: colors.white, fontSize: 19, fontFamily: fontFamilies.semiBold },
	dayCopy: { flex: 1, minWidth: 0, alignItems: 'flex-end' },
	dayTitle: { fontSize: 18, fontFamily: fontFamilies.semiBold, color: colors.textPrimary, writingDirection: 'rtl' },
	dayMeta: { marginTop: 5, fontSize: 12, fontFamily: fontFamilies.semiBold, color: colors.primary, writingDirection: 'rtl' },
	dayNote: { paddingHorizontal: 14, paddingVertical: 12, borderTopWidth: 1, borderTopColor: colors.borderLight },
	dayNoteTitle: { fontSize: 12, fontFamily: fontFamilies.semiBold, color: colors.textSecondary, textAlign: 'right', writingDirection: 'rtl' },
	dayNoteText: { marginTop: 4, fontSize: 13, lineHeight: 19, color: colors.textPrimary, textAlign: 'right', writingDirection: 'rtl' },
	emptyDay: { minHeight: 110, alignItems: 'center', justifyContent: 'center', gap: 8, padding: 20 },
	emptyDayText: { fontSize: 13, color: colors.textMuted, textAlign: 'center', writingDirection: 'rtl' },
	stopsList: { padding: 12, gap: 10 },
	legEstimate: { minHeight: 34, paddingHorizontal: 10, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 6 },
	legEstimateText: { flexShrink: 1, fontSize: 11, lineHeight: 16, color: colors.textMuted, textAlign: 'center', writingDirection: 'rtl' },
	stopCard: {
		width: '100%', minHeight: 94, padding: 10, borderRadius: 16, borderWidth: 1,
		borderColor: colors.borderLight, backgroundColor: colors.white,
	},
	stopCardExpanded: { borderColor: 'rgba(30,58,95,0.30)', backgroundColor: '#FCFDFE' },
	stopHeader: { minHeight: 72, flexDirection: 'row-reverse', alignItems: 'center', gap: 10 },
	...
	stopCopy: { flex: 1, minWidth: 0, minHeight: 54, justifyContent: 'center', alignItems: 'flex-end' },
	stopTitle: { fontSize: 14, fontFamily: fontFamilies.semiBold, color: colors.textPrimary, textAlign: 'right', writingDirection: 'rtl' },
	stopMeta: { marginTop: 3, fontSize: 12, fontFamily: fontFamilies.medium, color: colors.primary, textAlign: 'right', writingDirection: 'rtl' },
	locationLine: { marginTop: 4, flexDirection: 'row-reverse', alignItems: 'center', flexWrap: 'wrap', gap: 5 },
	generalBadge: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 9, backgroundColor: '#FFF4E4' },
	generalBadgeText: { fontSize: 9, fontFamily: fontFamilies.semiBold, color: '#A45B00', writingDirection: 'rtl' },
	stopAddress: { flexShrink: 1, fontSize: 11, lineHeight: 16, color: colors.textMuted, textAlign: 'right', writingDirection: 'rtl' },
	mapButton: {
		width: 44, height: 44, borderRadius: 14, backgroundColor: '#E7F7F5',
		alignItems: 'center', justifyContent: 'center',
	},
	stopExpanded: { marginTop: 10, paddingTop: 12, borderTopWidth: 1, borderTopColor: colors.borderLight },
	stopDescription: { fontSize: 13, lineHeight: 20, color: colors.textSecondary, textAlign: 'right', writingDirection: 'rtl' },
	stopExpandedAddressRow: { marginTop: 10, flexDirection: 'row-reverse', alignItems: 'flex-start', gap: 6 },
	stopExpandedAddress: { flex: 1, fontSize: 12, lineHeight: 18, color: colors.textMuted, textAlign: 'right', writingDirection: 'rtl' },
	photoStrip: { marginTop: 12, flexDirection: 'row-reverse', gap: 8 },
	photoStripButton: { width: 92, height: 72, borderRadius: 12, overflow: 'hidden' },
	photoStripImage: { width: '100%', height: '100%', backgroundColor: colors.borderLight },
	stopActions: { marginTop: 12, flexDirection: 'row-reverse', flexWrap: 'wrap', gap: 8 },
	primaryAction: { minHeight: 44, paddingHorizontal: 14, borderRadius: 13, backgroundColor: colors.primary, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 7 },
	primaryActionText: { color: colors.white, fontSize: 12, fontFamily: fontFamilies.semiBold, writingDirection: 'rtl' },
	secondaryAction: { minHeight: 44, paddingHorizontal: 14, borderRadius: 13, borderWidth: 1, borderColor: 'rgba(30,58,95,0.20)', backgroundColor: colors.white, flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 7 },
	secondaryActionText: { color: colors.primary, fontSize: 12, fontFamily: fontFamilies.semiBold, writingDirection: 'rtl' },
	dayNavigation: { padding: 12, borderTopWidth: 1, borderTopColor: colors.borderLight, flexDirection: 'row-reverse', justifyContent: 'space-between', gap: 10 },
	dayNavigationButton: { minHeight: 44, flex: 1, paddingHorizontal: 10, borderRadius: 13, backgroundColor: '#EEF3F8', flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 5 },
	dayNavigationButtonDisabled: { backgroundColor: colors.surfaceSubtle },
	dayNavigationText: { fontSize: 12, fontFamily: fontFamilies.semiBold, color: colors.primary, writingDirection: 'rtl' },
	dayNavigationTextDisabled: { color: colors.textMuted },
});
...
export const routeMapStyles = StyleSheet.create({
	...
	mapDayTabActive: { backgroundColor: colors.primary, borderColor: colors.brandOrange },
	mapDayTabText: { color: colors.textSecondary, fontSize: 12, fontFamily: fontFamilies.semiBold, writingDirection: 'rtl' },
	mapDayTabTextActive: { color: colors.white },
	map: {
		flex: 1,
	},
	mapWrap: {
	...
	mapHiddenNotice: {
		position: 'absolute', left: 18, right: 18, top: 14, minHeight: 38,
		borderRadius: 14, paddingHorizontal: 12, paddingVertical: 8,
		backgroundColor: 'rgba(255,255,255,0.96)', borderWidth: 1,
		borderColor: 'rgba(30,58,95,0.12)', alignItems: 'center', justifyContent: 'center',
		zIndex: 17, ...shadows.small,
	},
	mapHiddenNoticeText: { fontSize: 11, color: colors.textSecondary, textAlign: 'center', writingDirection: 'rtl' },
	webListContent: { paddingHorizontal: spacing.xl, paddingVertical: spacing.xl, alignItems: 'center' },
	webNotice: { width: '100%', maxWidth: 680, marginTop: 12, padding: 12, borderRadius: 14, backgroundColor: '#F7F9FC' },
	webNoticeText: { color: colors.textSecondary, fontSize: 12, textAlign: 'right', writingDirection: 'rtl' },
	webStopCard: {
	...
	webStopCardDisabled: { opacity: 0.72, backgroundColor: colors.surfaceSubtle },
	...
	segmentOverlay: { flex: 1, backgroundColor: 'rgba(15,23,42,0.42)', justifyContent: 'flex-end' },
	segmentSheet: {
		backgroundColor: colors.white, borderTopLeftRadius: 24, borderTopRightRadius: 24,
		paddingHorizontal: 18, paddingTop: 10, paddingBottom: 28, ...shadows.medium,
	},
	segmentHandle: { alignSelf: 'center', width: 44, height: 4, borderRadius: 2, backgroundColor: colors.border, marginBottom: 14 },
	segmentTitle: { fontSize: 18, fontFamily: fontFamilies.semiBold, color: colors.textPrimary, textAlign: 'right', writingDirection: 'rtl' },
	segmentDescription: { marginTop: 6, marginBottom: 10, fontSize: 12, lineHeight: 18, color: colors.textSecondary, textAlign: 'right', writingDirection: 'rtl' },
	segmentOption: { minHeight: 60, marginTop: 8, paddingHorizontal: 12, borderRadius: 15, borderWidth: 1, borderColor: colors.borderLight, backgroundColor: '#F8FAFC', flexDirection: 'row-reverse', alignItems: 'center', gap: 10 },
	segmentOptionCopy: { flex: 1, minWidth: 0, alignItems: 'flex-end' },
	segmentOptionTitle: { fontSize: 14, fontFamily: fontFamilies.semiBold, color: colors.textPrimary, writingDirection: 'rtl' },
	segmentOptionText: { marginTop: 2, fontSize: 11, color: colors.textMuted, writingDirection: 'rtl' },
});
