...
export const routeBuilderStyles = StyleSheet.create({
  ...
  dayContent: { gap: 12 },
  emptyDay: { alignItems: 'center', padding: 24, borderRadius: 18, backgroundColor: colors.white, gap: 12 },
  dayPhotoButton: { width: 72, height: 64, borderRadius: 12, overflow: 'hidden' },
  dayPhoto: { width: '100%', height: '100%' },
  photoCaption: { position: 'absolute', bottom: 4, right: 4, color: colors.white, backgroundColor: colors.primary, borderRadius: 8, minWidth: 20, textAlign: 'center' },
  stopShell: { borderRadius: 18, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.white, overflow: 'hidden' },
  stopShellOpen: { borderColor: colors.brandOrange },
  ...
  stopAction: { minWidth: 44, minHeight: 44, alignItems: 'center', justifyContent: 'center' },
