...
test('native evidence survives JavaScript and runner edits but not native config, dependencies or JDK changes', (t) => {
  ...
  write('client/modules/transfers/.gitignore', '/android/build/\n');
  write('client/modules/transfers/android/src/Transfers.kt', 'original module');
  ...
  write('client/modules/transfers/android/build/output.jar', 'generated build output');
  assert.equal(binarySignature(options), initial);
  write('client/modules/transfers/android/src/Transfers.kt', 'changed module');
  assert.notEqual(binarySignature(options), initial);
  write('client/modules/transfers/android/src/Transfers.kt', 'original module');
